...
requirements = python3,kivy,pywebview,pyjnius,requests,Pillow,opencv-python-headless==4.10.0.84,numpy,numba==0.61.0,UnityPy==1.10.18,PyYAML,websockets,fsb5==1.0,mido,pydub==0.25.1,rjsmin,librosa,android
