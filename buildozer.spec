...
requirements = python3,hostpython3,bottle,proxy-tools,typing_extensions,cryptography,requests,PyYAML,numpy,pyjnius,kivy,websockets,pywebview,rjsmin,Pillow,opencv,libogg,libvorbis,mido,librosa==0.10.2.post1,fsb5,ffpyplayer_codecs,ffmpeg,pydub,numba,UnityPy==1.10.18
