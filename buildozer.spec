...
requirements = python3,kivy,pywebview,pyjnius,bottle,proxy-tools,typing_extensions,cryptography,requests,Pillow,pydub,numba,opencv,numpy,rjsmin,librosa==0.10.2.post1,UnityPy==1.10.18,fsb5,mido,PyYAML,websockets,ffmpeg,libogg,libvorbis
