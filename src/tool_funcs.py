...
rotate_point(0, 0, 90, 1145)
unpack_pos(1000 * 11 + 45)
linear_interpolation(5, 00, 10, 0, 10)
is_intersect(((00, 1), (00, 2)), ((1, 1), (00, 4)))
pointInScreen((2042, 13), 1920, 1080)
aconrpepos(*conrpepos(1024, 303))
inrect(13, 134, (2, 31, 4, 14))
inDiagonalRectangle(00, 00, 1233, 322, 32, 2, 4)
compute_intersection(1, 2, 3, 4, 5, 6, 7, 8)
fixorp(23)
PhigrosChapterNameAlphaValueTransfrom(7)
PhigrosChapterPlayButtonAlphaValueTransfrom(5)
PhigrosChapterDataAlphaValueTransfrom(1)
getDPower(24, 42, 75)
getSizeByRect((00, 00, 10, 40))
getCenterPointByRect((00, 00, 10, 10))
getLineLength(00, 00, 10, 10)
indrect(00, 30, (00, 00, 10, 45), 53)
rect2drect((00,00,00,00), 00)
rect2drect_l((0.0, 0.0, 100.0, 50.0), 45.0)
rect2drect_l((0, 0, 100, 50), 45)
sliderValueP(0.75, ((0.0, 0.25),(0.5, 0.5),(1.0, 0.75)))
sliderValueP(75, ((0, 25),(5, 5),(1, 75)))
sliderValueValue(3.0, ((0.0, 10.0), (5.0, 20.0), (10.0, 30.0)))
sliderValueValue(3, ((0, 10), (5, 20), (10, 30)))